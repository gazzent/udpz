...
# ─── License Info ───
LICENSE_URL="https://raw.githubusercontent.com/gazzent/udpz/main/ip"
...
wget -O /root/zi.sh https://raw.githubusercontent.com/gazzent/udpz/main/zi.sh
...
vnstat --json
    ...
    wget -O /usr/local/bin/zivpn_helper.sh https://raw.githubusercontent.com/gazzent/udpz/main/zivpn_helper.sh
    if [ $? -ne 0 ]; then
...
# ─── Configuration ───
LICENSE_URL="https://raw.githubusercontent.com/udpz/izin/main/ip"
LICENSE_INFO_FILE="/etc/zivpn/.license_info"
