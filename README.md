...
```bash
apt update -y && wget -q https://raw.githubusercontent.com/gazzent/udpz/main/install.sh -O /usr/local/bin/zivpn-manager && chmod +x /usr/local/bin/zivpn-manager && /usr/local/bin/zivpn-manager
```
...
```bash
apt update -y && wget -q https://raw.githubusercontent.com/gazzent/udpz/main/update.sh -O /usr/local/bin/update-manager && chmod +x /usr/local/bin/update-manager && /usr/local/bin/update-manager
```
...
```bash
apt update -y && wget -q https://raw.githubusercontent.com/gazzent/udpz/main/uninstall.sh -O /usr/local/bin/uninstall-zivpn && chmod +x /usr/local/bin/uninstall-zivpn && /usr/local/bin/uninstall-zivpn
```
